    ...
    public partial class InitialModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(nullable: false),
                    SuggestedModel = table.Column<string>(maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Suggestio__UserI__182C9B23",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Users_Rat__UserI__21B6055D",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Users_Rev__UserI__24927208",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Buys__7D0B4B083DAE476E", x => new { x.UserId, x.UserProductId });
                    table.ForeignKey(
                        name: "FK__Buys__UserId__36B12243",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__Buys__UserProduc__37A5467C",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserProd__5ED6B798A1DCD7A9", x => new { x.Images, x.UserProductId });
                    table.ForeignKey(
                        name: "FK__UserProdu__UserP__3A81B327",
                        column: x => x.UserProductId,
                        principalTable: "UserProduct",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buys_UserProductId",
                table: "Buys",
                column: "UserProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryAttributes_CategoryAttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProduct_Images_UserProductId",
                table: "UserProduct_Images",
                column: "UserProductId");
        }
